...
python3 ddpm.py --mode 'sample_cfg' --n_steps "$n_steps" --lbeta "$lbeta" --ubeta "$ubeta" --epochs "$epochs" --n_samples "$n_samples" --batch_size "$batch_size" --lr "$lr" --n_dim "$n_dim" --dataset "$dataset"