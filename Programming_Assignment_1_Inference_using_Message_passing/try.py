...
def whether_trinagulated(graph, adjacency_matrix):
...
class Inference:
    ...
    def get_junction_tree(self):
        ...
        """
        tree_edges = []
        maximal_cliques = self.triangulate_and_get_cliques()
        ...
        while tree_edges:
            ...
            if union(tuple(c1), tuple(c2)):
                mst[tuple(c1)].append(tuple(c2))
                mst[tuple(c2).append(tuple(c1))]
            print (mst)
        return mst
